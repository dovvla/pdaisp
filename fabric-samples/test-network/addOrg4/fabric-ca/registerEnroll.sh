...
function createOrg4 {
  ...
  set -x
	fabric-ca-client register --caname ca-org4 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

	infoln "Registering peer2"
  set -x
	fabric-ca-client register --caname ca-org4 --id.name peer2 --id.secret peer2pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

	infoln "Registering peer3"
  set -x
	fabric-ca-client register --caname ca-org4 --id.name peer3 --id.secret peer3pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/msp --csr.hosts peer1.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the peer2 msp"
  set -x
	fabric-ca-client enroll -u https://peer2:peer2pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/msp --csr.hosts peer2.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the peer3 msp"
  set -x
	fabric-ca-client enroll -u https://peer3:peer3pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer3.org4.example.com/msp --csr.hosts peer3.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/tls --enrollment.profile tls --csr.hosts peer1.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/tls --enrollment.profile tls --csr.hosts peer2.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer3:peer3pw@localhost:12054 --caname ca-org4 -M ${PWD}/../organizations/peerOrganizations/org4.example.com/peers/peer3.org4.example.com/tls --enrollment.profile tls --csr.hosts peer3.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
